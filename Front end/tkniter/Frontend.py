...
from tkinter import Scrollbar, PhotoImage, Listbox, messagebox
...
def open_new_page(welcome_message):
    ...
    welcome_window.title(welcome_message)
...
def forget_password():
    ...
    forget_password_window.geometry("600x400")
...
label_log_in_as = tk.Label(login_window, text="Welcome to innovatehers App", font=("Helvetica", 20, "bold"))
label_log_in_as.pack(pady=10)

label_log_in_as = tk.Label(login_window, text="Log in as", font=("Helvetica", 16))
...
role_dropdown = tk.OptionMenu(login_window, role_var, *roles)
role_dropdown.config(font=("Helvetica", 14))
role_dropdown.pack(pady=5)

label_email = tk.Label(login_window, text="Email", font=("Helvetica", 16))
label_email.pack(pady=5)
entry_email = tk.Entry(login_window, bg="#68e804", font=("Helvetica", 14))
...
label_password = tk.Label(login_window, text="Password", font=("Helvetica", 16))
label_password.pack(pady=5)
entry_password = tk.Entry(login_window, show="*", bg="#68e804", font=("Helvetica", 14))
...
login_button = tk.Button(login_window, text="Login", command=login, font=("Helvetica", 16))
login_button.pack(pady=20)

forget_password_link = tk.Label(login_window, text="Forgot your password?", fg="blue", cursor="hand2", font=("Helvetica", 14))
forget_password_link.pack(pady=10)
forget_password_link.bind("<Button-1>", lambda event: forget_password())

signup_link = tk.Label(login_window, text="New user? Sign up", fg="blue", cursor="hand2", font=("Helvetica", 14))
...
label_new_user = tk.Label(signup_window, text="Sign Up", font=("Helvetica", 20, "bold"))
label_new_user.pack(pady=10)

label_first_name = tk.Label(signup_window, text="First Name", font=("Helvetica", 16))
label_first_name.pack(pady=5)
entry_first_name = tk.Entry(signup_window, bg="#68e804", font=("Helvetica", 14))
...
label_last_name = tk.Label(signup_window, text="Last Name", font=("Helvetica", 16))
label_last_name.pack(pady=5)
entry_last_name = tk.Entry(signup_window, bg="#68e804", font=("Helvetica", 14))
...
label_new_email = tk.Label(signup_window, text="Email", font=("Helvetica", 16))
label_new_email.pack(pady=5)
entry_new_email = tk.Entry(signup_window, bg="#68e804", font=("Helvetica", 14))
...
label_new_password = tk.Label(signup_window, text="Password", font=("Helvetica", 16))
label_new_password.pack(pady=5)
entry_new_password = tk.Entry(signup_window, show="*", bg="#68e804", font=("Helvetica", 14))
...
label_confirm_password = tk.Label(signup_window, text="Confirm Password", font=("Helvetica", 16))
label_confirm_password.pack(pady=5)
entry_confirm_password = tk.Entry(signup_window, show="*", bg="#68e804", font=("Helvetica", 14))
...
create_user_button = tk.Button(signup_window, text="Submit", font=("Helvetica", 16))
create_user_button.pack(pady=10)

login_link = tk.Label(signup_window, text="Already have an account? Login here", fg="blue", cursor="hand2", font=("Helvetica", 14))
login_link.pack(pady=5)
